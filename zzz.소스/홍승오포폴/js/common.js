    ...
    $(".sns a").click(function (e) {
        ...
        switch (txt) {
            ...
            case "갤러리":
                ...
                break;
            case "인스타그램":
                url = "https://www.instagram.com/wooridle__amc/";
                break;
            case "페이스북":
                url = "https://www.facebook.com/24%EC%8B%9C-%EC%9A%B0%EB%A6%AC%EB%93%A4%EB%8F%99%EB%AC%BC%EB%A9%94%EB%94%94%EC%BB%AC%EC%84%BC%ED%84%B0-109290170637376/";
                break;
            case "트위터":
                url = "https://twitter.com/";
                break;
            case "유튜브":
                url = "https://www.youtube.com/channel/UCOcUpEgwuoIX7aBUgdqHDnA";
                break;
            case "카카오톡 상담":
